angular.module('myApp').controller('ListSessionTalkController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'SessionTalkService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, SessionTalkService) {
	...
	$scope.add = function () {
		$location.path('/sessionTalk/add');
	};

	$scope.edit = function (obj) {
		$location.path('/sessionTalk/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/sessionTalk/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/sessionTalk/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(SessionTalkService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(SessionTalkService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.importData = function () {
		...
		$location.path('/import/sessionTalk');		
	};
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			SessionTalkService, "sessionTalks", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------
	...
	function init() {
		SecurityService.getPermisionsFoResource('sessionTalk').then(function(httpData) {
