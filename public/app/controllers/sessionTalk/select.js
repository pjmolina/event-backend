angular.module('myApp').controller('SelectSessionTalkController', ['$http', '$scope', '$location', '$translate', '$q', '$timeout', 'NavigationService', 'EntityUtilService', 'SessionTalkService', function($http, $scope, $location, $translate, $q, $timeout, NavigationService, EntityUtilService, SessionTalkService) {
