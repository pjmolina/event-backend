angular.module('myApp').controller('ListSpeakerController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'SpeakerService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, SpeakerService) {
	...
	$scope.add = function () {
		$location.path('/speaker/add');
	};

	$scope.edit = function (obj) {
		$location.path('/speaker/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/speaker/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/speaker/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(SpeakerService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(SpeakerService, $scope.dataList, $scope.refresh);  
	}
	...
	function init() {
		SecurityService.getPermisionsFoResource('speaker').then(function(httpData) {
