angular.module('myApp').controller('ListSponsorController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'SponsorService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, SponsorService) {
	...
	$scope.add = function () {
		$location.path('/sponsor/add');
	};

	$scope.edit = function (obj) {
		$location.path('/sponsor/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/sponsor/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/sponsor/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(SponsorService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(SponsorService, $scope.dataList, $scope.refresh);  
	}
	...
	function init() {
		SecurityService.getPermisionsFoResource('sponsor').then(function(httpData) {
